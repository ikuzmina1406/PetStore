...
public class Post implements Command {
    ...
    private void pet() throws URISyntaxException {
        ...
        while (true) {
            ...
            System.out.println("You can update an existing pet by specifying it`s id new name and new status ");
            System.out.println("input `picture` (picture -> enter -> value of id of a pet -> enter -> the path to a picture ) ");
            System.out.println("input `create` (create -> enter  -> the path to a user json file [create file.json  -> enter the path -> enter) ]) ");
            System.out.println("input `update` (update -> enter -> value of name of a pet -> enter -> value of status of a pet ) ");
