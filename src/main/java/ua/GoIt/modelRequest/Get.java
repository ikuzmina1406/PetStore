package ua.GoIt.modelRequest;

import ua.GoIt.command.Command;
import ua.GoIt.console.ConsoleApp;
...
public class Get implements Command {
    ...
    private void pet() throws URISyntaxException {
        ...
        while (true){
            ...
            System.out.println("input `id` then enter a value of petId (id -> enter -> value of id)");
            System.out.println("input `status` then enter a value of status (status -> enter -> value of status");
    ...
    private void store() throws URISyntaxException {
        ...
        while (true){
            System.out.println("You can get inventories pet status ");
            System.out.println("You can find order by id ");
            System.out.println("input `inventory` (inventory -> enter ) ");
            System.out.println("input `order` then enter a value of orderId (order -> enter -> value of orderId)");
    ...
    private void user() throws URISyntaxException {
        ...
        while (true){
            ...
            System.out.println("input `getByUsername` (getByUserName -> enter -> value of username ) ");
            System.out.println("input `login` (login -> enter -> value of username -> enter -> value of password) ");
            System.out.println("input `logout` (logout -> enter ) ");

            String input = scanner.nextLine().toLowerCase();

            if(!(input.equals("getByUserName") || input.equals("login") || input.equals("logout"))){
                ConsoleApp.printErrorMessage("Your input could not be processed, try again ");
                continue;
            }

            if(input.equals("getByUserName")){
