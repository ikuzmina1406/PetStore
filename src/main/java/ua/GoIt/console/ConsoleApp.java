...
import ua.GoIt.modelRequest.Delete;
import ua.GoIt.modelRequest.Get;
import ua.GoIt.modelRequest.Post;
import ua.GoIt.modelRequest.Put;
...
public class ConsoleApp {
        ...
        private static void printWelcomeMessage(){
            ...
            System.out.println("Here you can send requests via console interface to the Swagger API ");
